...
Current based Leaky Integrate-and-Fire (LIF)は，シナプス電流と膜電位の2つの状態の時間変化を考慮
したモデルであり，以下の式で表される．
...
可能であることが挙げられる．一方で，SNNは入出力で扱うスパイクが微分不可能であるため，人口ニューラル
...
Current Based LIF(CUBA-LIF)モデルにリカレント接続を組み合わせた以下の式で定義される．

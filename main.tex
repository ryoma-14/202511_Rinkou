...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=80mm]{figures/SNN_operation.png}
  \caption{スパイキングニューラルネットワークの概念図 (\cite{SnnfromScratch}を一部改変)}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=80mm]{figures/Ingenuity.png}
  \caption{火星ドローンIngenuity (\cite{Ingenuity}より引用)}
...
\subsection{概要}
この研究では，イベントカメラを用いて取得したイベントベースの視覚情報を入力とし，低レベルの制御
